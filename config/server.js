...
class Server{
    ...
    middlewares(){
        ...
        this.app.use((request, response, next) => {
            ...
            if(process.env.APP_ENV === 'dev' || process.env.APP_ENV === 'production'){
                next();
            }
    ...
    initialize(){
        try{
            ...
            this.server.listen(this.port, async() => {
                ...
                process.env.APP_ENV === 'local' ? console.log(`🚀 @ http://localhost:${this.port}`) 
                : process.env.APP_ENV === 'dev' ? console.log('🚀 Server running on dev mode') : console.log('🚀 Server running on production mode');
